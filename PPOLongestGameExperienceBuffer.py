...
class PPOLongestGameExperienceBuffer:
    def __init__(self):
        self.full_experience_buffer = PPOExperienceBuffer()        
        self.longest_game_experience_buffer = PPOExperienceBuffer()
    ...
    def finalize_episode_with_next_values(self, next_value):
        ...
        if self.current_game_experience_buffer.size() >= self.longest_game_experience_buffer.size():
            self.longest_game_experience_buffer = self.current_game_experience_buffer.copy()
